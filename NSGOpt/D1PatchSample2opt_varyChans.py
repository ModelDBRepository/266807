...
if __name__ == '__main__':
    ...
    with MPICommExecutor(MPI.COMM_WORLD, root=0, max_workers=6) as executor:
        if executor is not None:
            ...
            datasuffix = '_post_injection_curve_tau_and_full_charging_curve_'
