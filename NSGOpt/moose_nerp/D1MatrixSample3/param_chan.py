...
Na_m_params = TauInfMinChannelParams(T_min=0.00015558369677734588,
 T_vdep=0.003271147224743697,
 T_vhalf=-0.06213472121730399,
 T_vslope=0.008,
 SS_min=0.0,
 SS_vdep=1.0,
 SS_vhalf=-0.025134721217304,
 SS_vslope=-0.01,
 T_power=2)

Na_h_params = TauInfMinChannelParams(T_min=0.0005657472379349754,
 T_vdep=0.0024651295770587154,
 T_vhalf=-0.029656829683379307,
 T_vslope=0.003,
 SS_min=0.0,
 SS_vdep=1.0,
 SS_vhalf=-0.0476568296833793,
 SS_vslope=0.006,
 T_power=1)
...
Kir_X_params = AlphaBetaChannelParams(A_rate=0.028869508417604866,
 A_B=0.0,
 A_C=0.0,
 A_vhalf=0.02662352103199027,
 A_vslope=0.011,
 B_rate=3608.688552200608,
 B_B=0.0,
 B_C=1.0,
 B_vhalf=-0.013376478968009732,
 B_vslope=-0.04)
...
qfactKaF = 2
KaF_X_params = AlphaBetaChannelParams(A_rate=10090.393520489697,
 A_B=0.0,
 A_C=1.0,
 A_vhalf=0.010220545773592833,
 A_vslope=-0.013,
 B_rate=2522.5983801224243,
 B_B=0.0,
 B_C=1.0,
 B_vhalf=-0.009779454226407166,
 B_vslope=0.011)
...
KaF_Y_params = AlphaBetaChannelParams(A_rate=170.51424405145934,
 A_B=0.0,
 A_C=1.0,
 A_vhalf=0.1297424422272992,
 A_vslope=0.022,
 B_rate=105.55643679376055,
 B_B=0.0,
 B_C=1.0,
 B_vhalf=0.0637424422272992,
 B_vslope=-0.011)
...
KaS_X_params = AlphaBetaChannelParams(A_rate=109243.44331967544,
 A_B=0.0,
 A_C=1,
 A_vhalf=-0.09902180356090531,
 A_vslope=-0.0162951634,
 B_rate=1723670210.6563032,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.38709673023909463,
 B_vslope=0.0218235302)

KaS_Y_params = AlphaBetaChannelParams(A_rate=109296650.06729716,
 A_B=0.0,
 A_C=1.0,
 A_vhalf=1.2217303601028042,
 A_vslope=0.0645391447,
 B_rate=5.49581275967564,
 B_B=0.0,
 B_C=1.0,
 B_vhalf=0.00036596290480432354,
