...
Na_m_params = TauInfMinChannelParams(T_min=0.0035084077848922318,
 T_vdep=0.07376427367735919,
 T_vhalf=-0.06691748703981616,
 T_vslope=0.008,
 SS_min=0.0,
 SS_vdep=1.0,
 SS_vhalf=-0.029917487039816174,
 SS_vslope=-0.01,
 T_power=2)

Na_h_params = TauInfMinChannelParams(T_min=0.0015874293151377588,
 T_vdep=0.006916903333933587,
 T_vhalf=-0.017740066751343157,
 T_vslope=0.003,
 SS_min=0.0,
 SS_vdep=1.0,
 SS_vhalf=-0.035740066751343155,
 SS_vslope=0.006,
 T_power=1)
...
Kir_X_params = AlphaBetaChannelParams(A_rate=0.00934126853659126,
 A_B=0.0,
 A_C=0.0,
 A_vhalf=0.07134678090973132,
 A_vslope=0.011,
 B_rate=1167.6585670739075,
 B_B=0.0,
 B_C=1.0,
 B_vhalf=0.031346780909731316,
 B_vslope=-0.04)
...
qfactKaF = 2
KaF_X_params = AlphaBetaChannelParams(A_rate=302.9378080072434,
 A_B=0.0,
 A_C=1.0,
 A_vhalf=0.08212112176891444,
 A_vslope=-0.013,
 B_rate=75.73445200181085,
 B_B=0.0,
 B_C=1.0,
 B_vhalf=0.06212112176891445,
 B_vslope=0.011)
...
KaF_Y_params = AlphaBetaChannelParams(A_rate=664.3744174532015,
 A_B=0.0,
 A_C=1.0,
 A_vhalf=0.18705107024911674,
 A_vslope=0.022,
 B_rate=411.2794012805534,
 B_B=0.0,
 B_C=1.0,
 B_vhalf=0.1210510702491168,
 B_vslope=-0.011)
...
KaS_X_params = AlphaBetaChannelParams(A_rate=7707.275766630148,
 A_B=0.0,
 A_C=1,
 A_vhalf=-0.12645568091156878,
 A_vslope=-0.0162951634,
 B_rate=121607313.35956465,
 B_B=0.0,
 B_C=1,
 B_vhalf=0.35966285288843114,
 B_vslope=0.0218235302)

KaS_Y_params = AlphaBetaChannelParams(A_rate=370108729.39024115,
 A_B=0.0,
 A_C=1.0,
 A_vhalf=1.2342964580809705,
 A_vslope=0.0645391447,
 B_rate=18.610344198086604,
 B_B=0.0,
 B_C=1.0,
 B_vhalf=0.012932060882970421,
